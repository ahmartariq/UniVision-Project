...
export const UniversitiesSummary = () => {
            ...
            <Grid container spacing={0}>
                <Grid lg={12} md={12} sm={12} xs={12} container>
                    ...
                    <Grid lg={12} md={12} sm={12} xs={12} container columnGap={6} rowGap={2}>
                      <Grid lg={12} md={12} sm={12} xs={12}><h4 className='blue' style={{fontSize : '24px' , marginBottom : '0'}}>Summary</h4></Grid>
                      <Grid lg={12} md={12} sm={12} xs={12} container  columnGap={12} rowGap={5}> 
                        <Grid lg={5} md={5} sm={12} xs={12} direction={'column'}
                        style={{borderRight : '1px solid  #3A9AB7' }} className='noLine'>
                          <Grid lg={11} md={12} sm={12} xs={12} style={{padding : '18px 0' , borderBottom : '1px solid #3A9AB7'}}>
                            <p style={{fontSize : '16px'}}>Ranking</p>
                            <p style={{fontSize : '18px'}} className='blue'>#5 QS World Ranking</p>
                          </Grid>
                          <Grid lg={11} md={12} sm={12} xs={12} style={{padding : '18px 0' , borderBottom : '1px solid #3A9AB7'}}>
                            <p style={{fontSize : '16px'}}>Courses Offered</p>
                            <p style={{fontSize : '18px'}} className='blue'>www.harvard.edu/courses</p>
                          </Grid>
                          <Grid lg={11} md={12} sm={12} xs={12} style={{padding : '18px 0' , borderBottom : '1px solid #3A9AB7'}}>
                            <p style={{fontSize : '16px'}}>Courses Duration</p>
                            <p style={{fontSize : '18px'}} className='blue'>Variable(1,2,4 Years)</p>
                          </Grid>
                          <Grid lg={11} md={12} sm={12} xs={12} style={{padding : '18px 0' , borderBottom : '1px solid #3A9AB7'}}>
                            <p style={{fontSize : '16px'}}>Status</p>
                            <p style={{fontSize : '18px'}} className='blue'>Public</p>
                          </Grid>
                        </Grid>
                        <Grid lg={6} md={6} sm={12} xs={12} direction={'column'}>
                          <Grid lg={11} md={12} sm={12} xs={12} style={{padding : '18px 0' , borderBottom : '1px solid #3A9AB7'}}>
                            <p style={{fontSize : '16px'}}>Primary Campus</p>
                            <p style={{fontSize : '18px'}} className='blue'>Cambridge</p>
                          </Grid>
                          <Grid lg={11} md={12} sm={12} xs={12} style={{padding : '18px 0' , borderBottom : '1px solid #3A9AB7'}}>
                            <p style={{fontSize : '16px'}}>Fee Structure</p>
                            <p style={{fontSize : '18px'}} className='blue'>www.harvard.edu/fee_structure</p>
                          </Grid>
                          <Grid lg={11} md={12} sm={12} xs={12} style={{padding : '18px 0' , borderBottom : '1px solid #3A9AB7'}}>
                            <p style={{fontSize : '16px'}}>Scholarship Availability</p>
                            <p style={{fontSize : '18px'}} className='blue'>Available</p>
                          </Grid>
                          <Grid lg={11} md={12} sm={12} xs={12} style={{padding : '18px 0' , borderBottom : '1px solid #3A9AB7'}}>
                            <p style={{fontSize : '16px'}}>Research Output</p>
                            <p style={{fontSize : '18px'}} className='blue'>Very High</p>
                          </Grid>
                        </Grid>

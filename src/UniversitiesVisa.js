            ...
            <Grid container spacing={0}>
                <Grid lg={12} md={12} sm={12} xs={12} container>
                    ...
                    <Grid lg={12} md={12} sm={12} xs={12} container columnGap={6} rowGap={2}>
                      <Grid lg={12} md={12} sm={12} xs={12}><h4 className='blue' style={{fontSize : '24px'}}>Visa Requirements</h4></Grid>
                      <Grid lg={7.5} md={7.5} sm={12} xs={12} container  columnGap={0} rowGap={5}
                      style={{padding : '30px 8px',backgroundColor : '#F5F5F5' , borderRadius : '10px'}}> 
                        <Grid lg={6} md={6} sm={12} xs={12} direction={'column'} display={'flex'} alignItems={'center'}
                        style={{borderRight : '1px solid  #3A9AB7' }} className='noLine'>
                            <img src={Yes} alt='yes'/>
                            <p style={{fontSize : '16px'}}>Required for International Students</p>
                        </Grid>
                        <Grid lg={6} md={6} sm={12} xs={12}container direction={'row'}
                        style={{paddingLeft : '20px'}}>
                            <Grid lg={6} md={6} sm={6} xs={6} display={'flex'} alignItems={'center'} direction={'column'}>
                                <p style={{fontSize : '16px'}} className='blue'>Cost of Application</p>
                                <p style={{fontSize : '16px' , padding : '10px 0'}} className='blue'>Medical Fees</p>
                                <p style={{fontSize : '16px'}} className='blue'>Miscellaneous Fees</p>
                            </Grid>
                            <Grid lg={6} md={6} sm={6} xs={6} display={'flex'} alignItems={'center'} direction={'column'}>
                                <p style={{fontSize : '16px'}} >USD 2,000</p>
                                <p style={{fontSize : '16px' , padding : '10px 0'}} >USD 325</p>
                                <p style={{fontSize : '16px'}} >USD 100</p>
                            </Grid>
                        </Grid>
                      </Grid>
                      <Grid lg={4} md={4} sm={12} xs={12} container justifyContent={'center'} alignItems={'center'}
                      style={{padding : '30px 8px',backgroundColor : '#F5F5F5' , borderRadius : '10px'}}
                      >
                        <Grid lg={4} md={4} sm={4} xs={4} container alignItems={'center'} justifyContent={'center'}
                        style={{borderRight : '1px solid  #3A9AB7' }}>
                          <img src={Hourglass} alt='hourglass'/>
                        </Grid>
                        <Grid lg={8} md={8} sm={8} xs={8} style={{paddingLeft : '20px'}} container direction={'column'} alignItems={'center'} justifyContent={'center'}>
                            <p style={{fontSize : '45px'}} className='blue'>4 Years</p>
                            <p style={{fontSize : '17px'}}>Duration of Visa</p>
                        </Grid>
                      </Grid>
                    </Grid>
                    <Grid lg={12} md={12} sm={12} xs={12} container columnGap={2} rowGap={1}>
                        <Grid lg={12} md={12} sm={12} xs={12}><h4 className='blue' style={{fontSize : '24px' , marginBottom : '0'}}>Visa Processing Journey</h4></Grid>
                        <Grid lg={12} md={12} sm={12} xs={12}>
                          <p style={{fontSize : '16px', marginBottom : '10px'}}>Below in the representation of the Visa processing journey for student.</p>
                        </Grid>
                      <Grid lg={12} md={12} sm={12} xs={12} container alignItems={'center'} justifyContent={'center'}
                      style={{padding : '30px 8px',backgroundColor : '#F5F5F5' , borderRadius : '10px'}}> 
                        <div>
                        <img style={{width : '100%'}} src={Visa} alt='visa processing' />
                        </div>
                      </Grid>
                    </Grid>
                </Grid>

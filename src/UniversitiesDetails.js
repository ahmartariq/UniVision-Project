          ...
          <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            <Grid container spacing={0}>
                <Grid lg={12} md={12} sm={12} xs={12} container>
                    ...
                    <Grid lg={12} md={12} sm={12} xs={12} marginTop={2} container direction={'row'}>
                      <Grid lg={6} md={6} sm={12} xs={12} display={'flex'} direction={'column'} marginRight={5}>
                      <Grid lg={12} md={12} sm={12} xs={12} direction = {'row'} container style={{padding : '30px 40px'}}>
                          <Grid g={4} md={4} sm={4} xs={12} alignItems={'center'} display={'flex'} direction={'column'} justifyContent={'center'}>
                            <p style={{fontSize : '17px'}}>Total UG Students</p>
                            <p className='blue' style={{fontSize : '22px'}}>27,000</p>
                          </Grid>
                          <Grid g={4} md={4} sm={4} xs={12} alignItems={'center'} display={'flex'} direction={'column'} justifyContent={'center'}>
                            <p style={{fontSize : '17px'}}>Total UG Students</p>
                            <p className='blue' style={{fontSize : '22px'}}>15,000</p>
                          </Grid>
                          <Grid g={4} md={4} sm={4} xs={12} alignItems={'center'} display={'flex'} direction={'column'} justifyContent={'center'}>
                            <p style={{fontSize : '17px'}}>Average Class Size</p>
                            <p className='blue' style={{fontSize : '22px'}}>50</p>
                          </Grid>
                        </Grid>
                        <Grid lg={12} md={12} sm={12} xs={12} direction = {'row'} container style={{backgroundColor : '#F5F5F5' , padding : '30px 40px' , borderRadius : '10px'}}>
                          <Grid g={4} md={4} sm={4} xs={12} alignItems={'center'} display={'flex'} direction={'column'} justifyContent={'center'}>
                            <img src={Male} alt='male ratio'/>
                            <p>52% Male Students</p>
                          </Grid>
                          <Grid g={4} md={4} sm={4} xs={12} alignItems={'center'} display={'flex'} direction={'column'} justifyContent={'center'}>
                          <h1>VS</h1>
                          </Grid>
                          <Grid g={4} md={4} sm={4} xs={12} alignItems={'center'} display={'flex'} direction={'column'} justifyContent={'center'}>
                            <img src={Female} alt='female ratio'/>
                            <p>48% Female Students</p>
                          </Grid>
                        </Grid>
                        <Grid lg={12} md={12} sm={12} xs={12} direction = {'row'} container style={{padding : '30px 10px'}}>
                          <Grid g={4} md={4} sm={4} xs={12} alignItems={'center'} display={'flex'} direction={'column'} justifyContent={'center'}>
                            <p style={{fontSize : '17px'}}>Status</p>
                            <p className='blue' style={{fontSize : '22px'}}>Public</p>
                          </Grid>
                          <Grid g={4} md={4} sm={4} xs={12} alignItems={'center'} display={'flex'} direction={'column'} justifyContent={'center'}>
                            <p style={{fontSize : '17px'}}>Research Output</p>
                            <p className='blue' style={{fontSize : '22px'}}>Very High</p>
                          </Grid>
                          <Grid g={4} md={4} sm={4} xs={12} alignItems={'center'} display={'flex'} direction={'column'} justifyContent={'center'}>
                            <p style={{fontSize : '17px'}}>Avail Honours Program</p>
                            <p className='blue' style={{fontSize : '22px'}}>Yes</p>
                          </Grid>
                        </Grid>
                      </Grid>
                      <Grid lg={5} md={5} sm={12} xs={12} display={'flex'} direction={'column'}>
                        <Grid lg={12} md={12} sm={12} xs={12} direction = {'column'} container alignItems={'center'} justifyContent={'center'} marginBottom={2} style={{padding : '10px 8px',backgroundColor : '#F5F5F5' , borderRadius : '10px'}}>
                          <h1 className='blue' style={{fontSize : '45px'}}>63%</h1>
                          <p  style={{fontSize : '18px'}}>Acceptance Rate</p>
                        </Grid>
                        <Grid lg={12} md={12} sm={12} xs={12} direction = {'row'} container alignItems={'center'} justifyContent={'center'} marginBottom={2} style={{padding : '10px 8px',backgroundColor : '#F5F5F5' , borderRadius : '10px'}}>
                          <Grid g={6} md={6} sm={6} xs={12} alignItems={'center'} display={'flex'} direction={'column'} justifyContent={'center'}>
                            <p style={{fontSize : '45px'}} className='blue'>65%</p>
                            <p style={{fontSize : '18px'}}>Local Students</p>
                          </Grid>
                          <Grid g={6} md={6} sm={6} xs={12} alignItems={'center'} display={'flex'} direction={'column'} justifyContent={'center'}>
                            <p style={{fontSize : '45px'}} className='blue'>35%</p>
                            <p style={{fontSize : '18px'}}>International  Students</p>
                          </Grid>
                        </Grid>
                        <Grid lg={12} md={12} sm={12} xs={12} direction = {'row'} container alignItems={'center'} justifyContent={'center'} marginBottom={2} style={{padding : '10px 8px',backgroundColor : '#F5F5F5' , borderRadius : '10px'}}>
                          <Grid g={4} md={4} sm={4} xs={12} alignItems={'center'} display={'flex'} direction={'column'} justifyContent={'center'}>
                            <p style={{fontSize : '30px'}} className='blue'>SAT</p>
                            <p style={{fontSize : '18px'}}>Required</p>
                          </Grid>
                          <Grid g={4} md={4} sm={4} xs={12} alignItems={'center'} display={'flex'} direction={'column'} justifyContent={'center'}>
                            <p style={{fontSize : '30px'}} className='blue'>TOEFL</p>
                            <p style={{fontSize : '18px'}}>Required</p>
                          </Grid>
                          <Grid g={4} md={4} sm={4} xs={12} alignItems={'center'} display={'flex'} direction={'column'} justifyContent={'center'}>
                            <p style={{fontSize : '30px'}} className='blue'>ILETS</p>
                            <p style={{fontSize : '18px'}}>Required</p>
                          </Grid>
                        </Grid>
                      </Grid>

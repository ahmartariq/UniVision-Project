          ...
          <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            <Grid container spacing={0}>
              <Grid lg={12} md={12} sm={12} container>
                <Grid lg={6} md={6} sm={6}>
                  <h2 className='blue'>Questionnaire</h2>
                </Grid>
              ...
              <Grid lg={12} md={12} sm={12} container alignItems='center' style={{padding : '10px 15px' , backgroundColor : '#F5F5F5' , borderRadius : '10px'}}>
                <Grid lg={1} md={1} sm={1} container>
                    <div><img src={Group} style={{width: '50%'}}/></div>
                </Grid>
                <Grid lg={5} md={5} sm={5}>
                    <h4 style={{margin : '0'}}>Progress Questionnaire</h4>
                    <p>Created by School Representative</p>
                </Grid>
                <Grid lg={5} md={5} sm={5}>
                    <h4 style={{margin : '0'}}>Deadline</h4>
                    <p>11:59 PM, Oct 22</p>
                </Grid>
                <Grid lg={1} md={1} sm={1}  justifyContent='flex-end' display = 'flex'>
                    ...
                    onClick={() => {history.push('./progress-questionnaire')}}
                    >
                      <NavigateNext />
                    </IconButton>
                </Grid>

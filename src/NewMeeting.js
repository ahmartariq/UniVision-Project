...
import {IconButton , Button , TextField , InputLabel} from '@mui/material';
          ...
          <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            <Grid container spacing={0}>
             <Grid lg={12} md={12} sm={12} xs={12}>
                <h1 className='blue'>New Meeting</h1>
                <h2 className='blue' style={{fontWeight:'200'}}>Schedule new meeting</h2>
                <p>Do you need any guidance regarding admissions from your College counsellor, schedule a meeting now.</p>
                ...
                <TextField
                  ...
                  sx={{ marginBottom: 3, width: '50ch'}}
                  multiline
                  rows={5}
                  /><br/>
                  <Button variant='contained'
                  style={{width: '25ch',color : 'white' , padding : '10px 30px' , backgroundColor : '#3A9AB7'}}
                  >
                    Schedule
                  </Button>
                  </div>

...
export const UniversitiesPostGraduation = () => {
            ...
            <Grid container spacing={0}>
                <Grid lg={12} md={12} sm={12} xs={12} container>
                    ...
                    <Grid lg={12} md={12} sm={12} xs={12} container columnGap={6} rowGap={2}>
                      <Grid lg={12} md={12} sm={12} xs={12}><h4 className='blue' style={{fontSize : '24px'}}>Post Graduation</h4></Grid>
                      <Grid lg={4.5} md={4.5} sm={12} xs={12} container  columnGap={0} rowGap={5}
                      style={{padding : '30px 8px',backgroundColor : '#F5F5F5' , borderRadius : '10px'}}> 
                        ...
                        <Grid lg={6} md={6} sm={12} xs={12}container direction={'column'} alignItems={'center'}
                        style={{paddingLeft : '20px'}}>
                                <p style={{fontSize : '45px'}} className='blue'>90%</p>
                                <p style={{fontSize : '16px' , padding : '10px 0'}}>Employment Ratio</p>
                        </Grid>
                      </Grid>
                      <Grid lg={7} md={7} sm={12} xs={12} container justifyContent={'center'} alignItems={'center'} columnGap={0} rowGap={5}
                      style={{padding : '30px 8px',backgroundColor : '#F5F5F5' , borderRadius : '10px'}}
                      >
                        <Grid lg={4} md={4} sm={12} xs={12} container alignItems={'center'} justifyContent={'center'}
                        style={{borderRight : '1px solid  #3A9AB7' }} className='noLine'>
                          <img src={Salary} alt='hourglass'/>
                        </Grid>
                        <Grid lg={8} md={8} sm={12} xs={12} style={{paddingLeft : '20px'}} container direction={'column'} alignItems={'center'} justifyContent={'center'}>
                            <p style={{fontSize : '40px'}} className='blue'>USD 80,000</p>
                            <p style={{fontSize : '17px'}}>Average Graduate Salary (Yearly)</p>
                        </Grid>
                      </Grid>
                    </Grid>
                    <Grid lg={12} md={12} sm={12} xs={12} container columnGap={2} rowGap={1}>
                        <Grid lg={12} md={12} sm={12} xs={12}><h4 className='blue' style={{fontSize : '24px' , marginBottom : '10px'}}>Student Pathway after Graduation</h4></Grid>
                      <Grid lg={12} md={12} sm={12} xs={12} container alignItems={'center'} justifyContent={'center'}
                      style={{padding : '30px 8px',backgroundColor : '#F5F5F5' , borderRadius : '10px'}}> 
                        <div>
                        <img style={{width : '100%'}} src={Graduation} alt='graduation' />
                        </div>
                      </Grid>
                    </Grid>
                </Grid>

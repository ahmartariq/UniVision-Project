...
import {  IconButton, MenuItem , Menu,Button} from '@mui/material';
        ...
        >
          ...
          <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            <Grid container spacing={0}>
                <Grid lg={10} md={10} sm={10} xs={12} container direction='column'>
                    <h2 className='blue'>Recommender</h2>
                    <h4 className='blue'>Are you facing difficulty choosing university?</h4>
                    <p>Use our Recommender to help you find the best university for you, based on your performance. Take a peek at the video below to see how it works!</p>
                </Grid>
                <Grid  lg={9} md={9} sm={12} xs={12} justifyContent='center' alignItems='center' display='flex' direction='column' >
                    <div style={{justifySelf: 'center',width : '100%' , height : '346.32px' , backgroundColor : '#F5F5F5' , marginTop : '20px' , display : 'flex' , alignItems : 'center' , justifyContent : 'center'}}>
                        <PlayArrowIcon style={{transform : 'scale(5)' , color : '#3A9AB7'}}/>
                    </div>
                    <p style={{margin : '10px 0'}}>Ready to Start? click the Continue button to start now.</p>
                    <Button variant='contained'
                    style={{color : 'white' , padding : '5px 60px' ,
                    backgroundImage : 'linear-gradient(#3A9AB7 , #60DBD7)'}}

...
function createData(type, name, duration, cost, info) {
  return { type, name, duration, cost, info };
}
const rows = [
  createData('MBA', 'Master of Business Administration', '2 years', 'USD 3,00,000', 'www.harvard.edu/courses/MBA'),
  createData('BBA', 'Bachelor of Business Administration', '4 years', 'USD 2,50,000', 'www.harvard.edu/courses/BBA'),
  createData('BSc(Hons)', 'BSc (Hons) Degree in Applied Accounting', '2 years', 'USD 3,50,000', 'www.harvard.edu/courses/BSc_accounting'),
];
...
export const UniversitiesPrograms = () => {
            ...
            <Grid container spacing={0}>
                <Grid lg={12} md={12} sm={12} xs={12} container>
                    ...
                    <Grid lg={12} md={12} sm={12} xs={12} container columnGap={6} rowGap={2}>
                      <Grid lg={12} md={12} sm={12} xs={12}><h4 className='blue' style={{fontSize : '24px' , marginBottom : '0'}}>Programs</h4></Grid>
                      <Grid lg={12} md={12} sm={12} xs={12}>
                        <p style={{fontSize : '16px', marginBottom : '10px'}}>Select any program to see the respective courses offered. </p>
                      </Grid>
                      <Grid lg={12} md={12} sm={12} xs={12}>
                          ...
                          <Table sx={{ minWidth: 650}} className={classes.table}>
                            <TableHead>
                              <TableRow style={{backgroundColor : '#3A9AB7'}}>
                                ...
                                <TableCell style={{color : 'white'}}>Other info</TableCell>
                              </TableRow>
                            </TableHead>
                            <TableBody style={{backgroundColor : '#F5F5F5'}}>
                              {rows.map((row) => (
                                ...
                                >
                                  ...
                                  <TableCell><a href={row.info} className='blueHover' target='_blank'>{row.info}</a></TableCell>
                                </TableRow>
                              ))}
                            </TableBody>
                          </Table>
